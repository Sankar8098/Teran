...
"""
    ...
    await m.reply(
        ...
        buttons=[
            [
                Button.url(
                    "👑 Private Channel", url="https://t.me/+0C76LR5-jCw4NzM1"
                ),
                Button.url(
                    "Support 🍃",
                    url="https://t.me/NOOBTera",
                ),
            ],
            [
...
# ┃
# ┃ To check availabe plan do /plan in chat group @NOOBTera
# ╚═════════════════⍟
# For subscription inquiries, contact @l_abani.
# """

#     # Send the welcome message
#     check_if = await is_user_on_chat(bot, "@NOOBTera", m.peer_id)
#     if not check_if:
#         return await m.reply("Please join @NOOBTera then send me the link again.")
...
"""
    await m.reply(
        ...
        buttons=[
            [
                Button.url(
                    "👑 Private Channel", url="https://github.com/Abdul97233/TeraBox-Downloader-Bot"
                ),
                Button.url(
                    "Bot Source Code",
...
async def display_plan(m: UpdateNewMessage):
    plan_text = """
┏━━━━━━━━━━⍟
┃𝐍𝐎𝐎𝐁 𝐓𝐄𝐑𝐀 𝐁𝐎𝐗 𝐏𝐑𝐄𝐌𝐈𝐔𝐌 𝐁𝐎𝐓 𝐩𝐥𝐚𝐧
┗━━━━━━━━━━━━━━━━━⍟
...
To purchase premium, send a message to @l_abani.
"""
...
async def handle_message(m: Message):
    ...
    if not check_if:
        return await m.reply(
            "Please join @NOOBTera then send me the link again."
        )
    ...
    if int(data["sizebytes"]) > 6742022802 and m.sender_id not in [6742022802]:
        return await hm.edit(
